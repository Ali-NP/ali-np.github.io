<div style="display:flex;justify-content:center;align-items:center;gap:40px;margin-bottom:20px;">
    <img src="assets/tcnj-logo.png" width="220">
    <img src="assets/jlab-logo.jng" width="220">
</div>
...
***
*Institutional logos displayed for professional attribution purposes. Image credit: TCNJ Visual Identity Standards and DOE's Jefferson Lab.*
